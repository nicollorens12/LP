...
class hmVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by hmParser#abstractionExpression.
    def visitAbstractionExpression(self, ctx:hmParser.AbstractionExpressionContext):
        print("visitAbstractionExpression")
        return self.visitChildren(ctx)
